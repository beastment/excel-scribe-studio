...
import { generateSmallDemoComments, generateMediumDemoComments, generateLargeDemoComments } from '@/utils/demoDataGenerator';
const CommentEditorPage = () => {
  ...
  const loadDemoData = (size: 'small' | 'medium' | 'large' | 'original') => {
    setIsDemoData(true);
    let demoComments: CommentData[];
    let message: string;
    
    switch (size) {
      case 'small':
        demoComments = generateSmallDemoComments();
        message = 'Small demo data loaded successfully! 100 employee survey comments imported.';
        break;
      case 'medium':
        demoComments = generateMediumDemoComments();
        message = 'Medium demo data loaded successfully! 200 employee survey comments imported.';
        break;
      case 'large':
        demoComments = generateLargeDemoComments();
        message = 'Large demo data loaded successfully! 500 employee survey comments imported.';
        break;
      case 'original':
      default:
        ...
        message = 'Demo data loaded successfully! 20 employee survey comments imported.';
        break;
    }
            ...
            {comments.length === 0 ? <div className="animate-slide-up">
              ...
              <div className="flex flex-col items-center gap-4 mb-6">
                <div className="text-center mb-4">
                  <h3 className="text-lg font-semibold mb-2">Try Demo Files</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Choose from different sizes to test the system
                  </p>
                </div>
                <div className="flex flex-wrap gap-2 justify-center">
                  <Button onClick={() => loadDemoData('original')} variant="outline" className="gap-2">
                    <FileText className="w-4 h-4" />
                    Small (20)
                  </Button>
                  <Button onClick={() => loadDemoData('small')} variant="outline" className="gap-2">
                    <FileText className="w-4 h-4" />
                    Medium (100)
                  </Button>
                  <Button onClick={() => loadDemoData('medium')} variant="outline" className="gap-2">
                    <FileText className="w-4 h-4" />
                    Large (200)
                  </Button>
                  <Button onClick={() => loadDemoData('large')} variant="outline" className="gap-2">
                    <FileText className="w-4 h-4" />
                    Extra Large (500)
                  </Button>
                </div>
