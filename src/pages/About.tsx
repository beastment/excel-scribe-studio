              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                       <h3 className="text-xl font-semibold mb-3 text-card-foreground">Our Mission</h3>
                       <p className="text-muted-foreground">To unlock the true voice of employees through AI-powered analysis while ensuring complete data privacy and security.</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                       <h3 className="text-xl font-semibold mb-3 text-card-foreground">Our Vision</h3>
                       <p className="text-muted-foreground">A world where every organization can easily understand and act on employee feedback to create better workplaces.</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                       <h3 className="text-xl font-semibold mb-3 text-card-foreground">Our Commitment</h3>
                       <p className="text-muted-foreground">100% Australian data sovereignty, enterprise-grade security, and unwavering commitment to privacy protection.</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-500 rounded-2xl flex items-center justify-center mx-auto mb-6">
               ...
               <h3 className="text-xl font-semibold mb-4 text-foreground">Security First</h3>
               <p className="text-muted-foreground">Your data security and privacy are our highest priority. We employ enterprise-grade security measures and maintain complete transparency about our practices.</p>
            </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-6">
               ...
               <p className="text-muted-foreground">We continuously push the boundaries of what's possible with AI and machine learning to deliver cutting-edge solutions for our clients.</p>
            </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl flex items-center justify-center mx-auto mb-6">
               ...
               <p className="text-muted-foreground">Your success is our success. We're committed to providing exceptional support and ensuring you get maximum value from our platform.</p>
            </div>
          </div>
        </div>
      </section>
